...
{
    unsigned byte = (word >> (bytenum * 8)) & 0xFF;  // isola o byte - shift para a direita * numero de bytes mantendo apenas o byte desejado
    return (int)((char) byte); // char para comppletar como um signed e int para retornar certo
}
